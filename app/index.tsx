...
export default function Index() {
  const title = "MMSB Electronic Borelog";
        ...
        <MenuProvider skipInstanceCheck={true}>
          <View
            ...
            <View
              ...
              <ScrollView style={styles.operationDescriptionsContainer} automaticallyAdjustKeyboardInsets={true}>
                    ...
                    <MenuTrigger>
                      <View
                        style={{
                          ...
                          <Text>Choose Soil Type</Text>
                      </View>
                    </MenuTrigger>
                    <MenuOptions>
                      <MenuOption onSelect={ () => alert("Selected Soil Type 1") } style={{height: 40, alignItems: "center", justifyContent: "center",}}>
                        <Text>
                          Soil Type 1
                        </Text>
                      </MenuOption>
                      <MenuOption onSelect={ () => alert("Selected Soil Type 2") } style={{height: 40, alignItems: "center", justifyContent: "center",}}>
                        <Text>
                          Soil Type 2
                        </Text>
                      </MenuOption>
                      <MenuOption onSelect={ () => alert("Selected Soil Type 3") } style={{height: 40, alignItems: "center", justifyContent: "center",}}>
                        <Text>
                          Soil Type 3
                        </Text>
                      </MenuOption>
          ...
          <View
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <Text style={{borderWidth: 1, padding: 5,}}>Confirm Add</Text>
              </TouchableOpacity>
            </View>
          </View>
        </Modal>
